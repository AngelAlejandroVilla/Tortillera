...
import addPrice from './Add/AddPrice.vue'
...
export default {
  ...
  methods: {
    ...
    refreshInfo(){
      axios.get("http://hwsrv-966807.hostwindsdns.com:8080/dataSnap/rest/TCustomer/PriceList/"+ this.custumerId +"/All",{
        headers: {
            ...
            for (const i of this.prices) {
              this.productsPrices.push(i.ProductId)
            }
